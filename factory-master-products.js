/* FÁBRICA CHAÑAR — FABRICACIÓN MAESTRA v2
   Un botón: fabrica 1 unidad de cada producto maestro, aplica dato real,
...
(function(){
  ...
  window.FabricaMasterFactory={version:2,manufactureAll,applyMaster,products};
