...
(function(){
  const PRODUCTS={
    postal:{icon:'▣',name:'Postal',desc:'Recuerdo visual, breve y coleccionable.',hint:'Imagen protagonista · emoción · dato · sello'},
    ficha:{icon:'▤',name:'Ficha cultural',desc:'Pieza documental sobre un lugar o historia.',hint:'Contexto · categoría · lugar · procedencia'},
