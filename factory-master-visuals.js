/* FÁBRICA CHAÑAR — DIRECCIÓN DE PRODUCTO CERRADA v6
   UNA COLECCIÓN / CUATRO FORMATOS / UNA SUPERFICIE
   El sistema maestro no crea marcas, sellos ni ornamentos.
*/
(function(){
  const RECIPES={
  ...
  window.FabricaMasterVisuals={version:6,locked:true,apply,clear,recipes:RECIPES,products:['postal','ficha','guide','infographic']};
})();
